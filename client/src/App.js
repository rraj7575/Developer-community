...
const AsyncRegister = Loadable(
  doLoad(() => import("./components/auth/Register"))
);
const AsyncLogin = Loadable(doLoad(() => import("./components/auth/Login")));
const AsyncProfiles = Loadable(
  doLoad(() => import("./components/profiles/Profiles"))
);
const AsyncProfile = Loadable(
  doLoad(() => import("./components/profile/Profile"))
);
const AsyncDashboard = Loadable(
  doLoad(() => import("./components/dashboard/Dashboard"))
);
const AsyncCreateProfile = Loadable(
  doLoad(() => import("./components/create-profile/CreateProfile"))
);
const AsyncEditProfile = Loadable(
  doLoad(() => import("./components/edit-profile/EditProfile"))
);
const AsyncAddExperience = Loadable(
  doLoad(() => import("./components/add-credentials/AddExperience"))
);
const AsyncAddEducation = Loadable(
  doLoad(() => import("./components/add-credentials/AddEducation"))
);
